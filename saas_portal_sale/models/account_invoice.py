    ...
    def action_invoice_paid(self):
        ...
        for record in self:
            ...
            if plans:
                ...
                self.with_context(saas_domain=self.env['ir.config_parameter'].get_param('saas_portal.base_saas_domain'),plans=plans).message_post_with_template(template.id, compositon_mode='comment')
        return res
